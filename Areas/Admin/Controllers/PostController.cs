...
namespace MadhuBlog.Areas.Admin.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public PostController(ApplicationDbContext context, INotyfService notification, IWebHostEnvironment webHostEnvironment = null, UserManager<ApplicationUser> userManager = null)
        {
            _context = context;
